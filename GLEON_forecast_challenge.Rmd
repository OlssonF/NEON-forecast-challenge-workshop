...
* We could also look at the lake variables' relationship(s) with other variable. Could we use existing forecasts about the weather to generate forecasts about lake variables (Model 2- Linear Model with Co-variates).
...
>>>>>>> c0d1ad2abdc4669d6ef5a10f5ef229e4eda90920
...
# Model 2: Linear covariate model
...
forecast_name_3 <- 'GLEON_LM_forecast.csv' #this is our second model I think?
...
=======
Possible modifications to Model 2 (lines x-x):
>>>>>>> c0d1ad2abdc4669d6ef5a10f5ef229e4eda90920
...
forecast_name_2 <- 'GLEON_SN_forecast.csv' #this is our third model I think?
...
=======
Possible modifications to Model 3g (lines x-x):
>>>>>>> c0d1ad2abdc4669d6ef5a10f5ef229e4eda90920
