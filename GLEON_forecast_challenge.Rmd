...
# Model 2: Introducing co-variates
...
forecast_name_2 <- 'GLEON_LM_forecast.csv' #this is our second model I think?
forecast_file_2 <- paste(theme, date, forecast_name_2, sep = '-')

write_csv(temp_lm_forecast_EFI, forecast_file_2)
...
## TASKS
Possible modifications to Model 2 - simple linear model (lines x-x):
