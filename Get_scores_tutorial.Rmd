...
### 3. Forecast performance over horizon
...
scores |> 
  ...
  facet_grid(variable~site_id, scales = 'free') +
   ...
   # Make it better to look at 
  scale_colour_viridis_d(begin = 0.2, end = 0.8) +
  labs(y= 'CRPS', x= 'Horizon (days ahead)', title = 'Aggregated forecast performance over horizon') +
  theme_bw()
```
...
- Are there particular sites that generally have better/worse predictions?    