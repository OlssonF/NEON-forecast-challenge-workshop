...
To start off with Github actions you need a worflow yaml file. Yaml files are computer readable 'instructions' that essentially say what the Action needs to do.
