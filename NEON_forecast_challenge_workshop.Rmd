...
If you do not wish to run the code yourself you can follow along via the html (GLEON_forecast_challenge.md), which can be downloaded from the [Github repository](https://github.com/OlssonF/GLEON-forecast-challenge). 
